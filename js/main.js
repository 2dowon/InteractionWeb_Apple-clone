...
(() => {
    ...
    function setLayout() {
        ...
        // 새로 고침해서 스크롤을 하지 않았지만 현재 위치가 어느정도 스크롤된 위치일 때 currentScene을 구하기 위해
    ...
    function playAnimation() {
        ...
        switch (currentScene) {
            ...
            case 2:
                // console.log('2 play');
                let seqeunce2 = Math.round(calcValues(values.imageSequence, currentYOffset));
                objs.context.drawImage(objs.videoImages[seqeunce2], 0, 0);
    ...
    window.addEventListener('scroll', () => {
        yOffset = window.pageYOffset; // 스크롤을 얼마나 했는지
        scrollLoop();
    });
